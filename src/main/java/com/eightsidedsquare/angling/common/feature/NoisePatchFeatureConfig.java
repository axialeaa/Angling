...
public record NoisePatchFeatureConfig(BlockStateProvider blockStateProvider, int offset, double octave,
    double threshold, IntProvider radius) implements FeatureConfig {
